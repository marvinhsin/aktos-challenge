...
class LoadCSVTestCase(TestCase):
    def setUp(self):
        ...
        self.csv_file = SimpleUploadedFile("test.csv", csv_content.encode("utf-8"), content_type="text/csv")
    ...
    def test_load_csv_no_file_uploaded(self):
        ...
        self.assertEqual(response.status_code, 200)
        self.assertIn('<h1>No file uploaded or invalid request method</h1>', response.content.decode())
